...
\centering
\begin{tabular}{cccc}
\subfloat[Accumulator]{\includegraphics[width = 0.3\textwidth]{results/bottle-accumulator}} &
\subfloat[Detected contour]{\includegraphics[width = 0.3\textwidth]{results/bottle-overlay}} &
\subfloat[Detected contour in second image]{\includegraphics[width = 0.3\textwidth]{results/bottle-overlay2}} \\
